...
/**
 * Provides the local service interface for CompanyRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ashish
 * @see CompanyRequestLocalServiceUtil
...
public interface CompanyRequestLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompanyRequestLocalServiceUtil} to access the company request local service. Add custom service methods to {@link com.itlifter.employee.service.service.impl.CompanyRequestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
