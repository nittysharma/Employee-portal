...
/**
 * Provides the local service interface for company_request. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ashish
 * @see company_requestLocalServiceUtil
...
public interface company_requestLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link company_requestLocalServiceUtil} to access the company_request local service. Add custom service methods to {@link com.itlifter.employee.service.service.impl.company_requestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
