 ...
 * @generated
 */
public class company_requestSoap implements Serializable {
	public static company_requestSoap toSoapModel(company_request model) {
		company_requestSoap soapModel = new company_requestSoap();
	...
	public static company_requestSoap[] toSoapModels(company_request[] models) {
		company_requestSoap[] soapModels = new company_requestSoap[models.length];
	...
	public static company_requestSoap[][] toSoapModels(
		company_request[][] models) {
		company_requestSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new company_requestSoap[models.length][models[0].length];
		}
		else {
			soapModels = new company_requestSoap[0][0];
		}
	...
	public static company_requestSoap[] toSoapModels(
		List<company_request> models) {
		List<company_requestSoap> soapModels = new ArrayList<company_requestSoap>(models.size());

		for (company_request model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new company_requestSoap[soapModels.size()]);
	}

	public company_requestSoap() {
	}
